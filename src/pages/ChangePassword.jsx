  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        ...
        <label style={{ fontSize: 13, fontWeight: 600, color: error ? C.errorText : C.navy, fontFamily: font }}>
          {label}
        </label>
      </div>
      <div style={{
        ...
        height: 48, background: error ? C.errorBg : C.white,
        ...
        <input
          ...
          style={{
            ...
            fontSize: 14, color: "#0a0a0a", background: "transparent",
            fontFamily: font,
          }}
        />
        <button
      ...
      {error && (
        <p style={{ fontSize: 12, color: C.errorText, margin: 0, fontFamily: font }}>{error}</p>
      )}
    </div>
  );
}
...
export default function ChangePassword() {
  ...
  const handleSave = () => {
    ...
    // TODO: PATCH /api/users/password { currentPassword, newPassword }
    alert("パスワードを変更しました！");
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: font, paddingBottom: 80 }}>
      ...
      <div style={{ maxWidth: 820, margin: "0 auto", padding: "0 20px" }}>
        ...
        {/* ── 비밀번호 변경 카드 ── */}
        <div style={{
          background: C.white, borderRadius: 15, padding: "36px 32px",
          ...
          {/* 안내 메시지 */}
          <div style={{
            background: "#fff9e6", border: "1.2px solid rgba(202,202,0,0.2)",
            borderRadius: 13, padding: "14px 18px",
            fontSize: 12, color: C.gray, fontFamily: font,
          }}>
          ...
          <div style={{ display: "flex", gap: 16, marginTop: 4 }}>
            <button
              ...
              style={{
                ...
                color: C.gray, fontSize: 15, fontWeight: 700,
