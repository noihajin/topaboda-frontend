...
const MOCK_HERITAGES = [
  { id: 1,  nameKo: "独島",            nameEn: "Dokdo",                      region: "慶北",  category: "天然記念物", img: "https://images.unsplash.com/photo-1559827260-dc66d52bef19?q=80&w=600" },
  { id: 2,  nameKo: "済州 漢拏山",      nameEn: "Hallasan Mountain",           region: "済州",  category: "天然記念物", img: "https://images.unsplash.com/photo-1570092640903-9f959e3f4456?q=80&w=600" },
  { id: 3,  nameKo: "訓民正音 解例本",  nameEn: "Hunminjeongeum Haerye",       region: "ソウル", category: "国宝",      img: "https://images.unsplash.com/photo-1618176729090-253077a8f948?q=80&w=600" },
  { id: 4,  nameKo: "景福宮",          nameEn: "Gyeongbokgung Palace",        region: "ソウル", category: "史跡",      img: "https://images.unsplash.com/photo-1548115184-bc6544d06a58?q=80&w=600" },
  { id: 5,  nameKo: "昌徳宮",          nameEn: "Changdeokgung Palace",        region: "ソウル", category: "史跡",      img: "https://images.unsplash.com/photo-1601042879364-f3947d3f9c16?q=80&w=600" },
  { id: 6,  nameKo: "水原 華城",        nameEn: "Hwaseong Fortress",           region: "京畿",  category: "史跡",      img: "https://images.unsplash.com/photo-1583422409516-2895a77efded?q=80&w=600" },
  { id: 7,  nameKo: "海印寺 八万大蔵経", nameEn: "Haeinsa Tripitaka Koreana",  region: "慶南",  category: "国宝",      img: "https://images.unsplash.com/photo-1590603740183-980e7f6920eb?q=80&w=600" },
  { id: 8,  nameKo: "石窟庵",          nameEn: "Seokguram Grotto",            region: "慶北",  category: "国宝",      img: "https://images.unsplash.com/photo-1621259182978-fbf93132d53d?q=80&w=600" },
  { id: 9,  nameKo: "宗廟",            nameEn: "Jongmyo Shrine",              region: "ソウル", category: "史跡",      img: "https://images.unsplash.com/photo-1578637387939-43c525550085?q=80&w=600" },
  { id: 10, nameKo: "仏国寺",          nameEn: "Bulguksa Temple",             region: "慶北",  category: "国宝",      img: "https://images.unsplash.com/photo-1590603740183-980e7f6920eb?q=80&w=600" },
  { id: 11, nameKo: "安東 河回村",      nameEn: "Hahoe Folk Village",          region: "慶北",  category: "民俗文化財", img: "https://images.unsplash.com/photo-1559827260-dc66d52bef19?q=80&w=600" },
  { id: 12, nameKo: "南漢山城",        nameEn: "Namhansanseong Fortress",     region: "京畿",  category: "史跡",      img: "https://images.unsplash.com/photo-1598935888738-cd2622bcd437?q=80&w=600" },
];
    ...
    >
      ...
      <div style={{ padding: "20px 22px 18px" }}>
        ...
        <div style={{ borderTop: `1px solid ${C.border}`, paddingTop: 14 }}>
          <span style={{ fontSize: 14, fontWeight: 600, color: C.red, fontFamily: font, opacity: hovered ? 1 : 0.85 }}>
            詳細を見る →
          </span>
        </div>
      </div>
