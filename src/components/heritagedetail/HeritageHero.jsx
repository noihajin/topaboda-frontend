...
export default function HeritageHero({ data, isLiked, isBookmarked, isLiking, isBookmarking, likeCount, onLike, onBookmark }) {
    ...
    return (
        <div style={{ position: "relative", height: "75vh", minHeight: 560 }}>
            <img src={data.thumbnail} alt={data.nameJa} style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
            ...
            <div style={{ position: "absolute", bottom: 56, left: 72 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    <IconMapPin />
                    <span style={{ fontSize: 16, color: "rgba(255,255,255,0.8)", fontFamily: font }}>{data.location}</span>
                </div>
            </div>
