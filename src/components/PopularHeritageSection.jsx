...
export default function PopularHeritageSection() {
  ...
  const MOCK_DATA = [
    { id: 1, name: "仏国寺", location: "慶州, 慶尚北道", views: 1234, badge: "国宝", imageUrl: "https://via.placeholder.com/400x300" },
    { id: 2, name: "景福宮", location: "ソウル", views: 2567, badge: "国宝", imageUrl: "https://via.placeholder.com/400x300" },
    { id: 3, name: "韓屋村", location: "全州, 全羅北道", views: 987, badge: "史跡", imageUrl: "https://via.placeholder.com/400x300" },
    { id: 4, name: "石窟庵", location: "慶州, 慶尚北道", views: 1456, badge: "国宝", imageUrl: "https://via.placeholder.com/400x300" },
    { id: 5, name: "青磁 象嵌", location: "国立中央博物館", views: 678, badge: "宝物", imageUrl: "https://via.placeholder.com/400x300" },
    { id: 6, name: "水原華城", location: "水原, 京畿道", views: 1823, badge: "史跡", imageUrl: "https://via.placeholder.com/400x300" },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center mb-20 text-center">
        ...
        <motion.h2 variants={itemVariants} className="text-4xl lg:text-5xl font-bold text-[#000D57] mb-6 tracking-tight">
          人気の国の遺産
        </motion.h2>
